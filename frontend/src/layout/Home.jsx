    ...
    <>
      <div className="flex flex-col items-center w-full mx-auto min-h-screen diagonal-background overflow-x-hidden">
        <div className="flex justify-between items-center w-full px-6 h-20 bg-[#00000012]">
          <div className="text-4xl font-bold text-white">TensorGo</div>
        ...
        >
          {data.map((item, idx) => (
            ...
            >
              ...
              <div className="mx-auto flex justify-center items-center my-3 space-x-4">
                {planType === item.title.toLowerCase() ? (
                ...
                <Link
                  ...
                  className="bg-[#3d5fc4] text-white rounded-md text-base uppercase w-24 py-2 font-bold flex items-center justify-center"
                >
                  Invoice
                </Link>
              </div>
